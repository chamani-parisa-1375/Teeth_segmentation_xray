...
def dice_iou_multiclass(y_true, y_pred, num_classes, eps=1e-7):
    """
    y_true, y_pred: HxW grayscale masks (class IDs per pixel)
    ...
    for c in range(num_classes):
        ...
        # Dice
        dice = (2. * intersection + eps) / (gt_sum + pred_sum + eps)
